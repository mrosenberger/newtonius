...
var handle_mouse_up = function(event) { 
  if (mouse_pressed) {
    ...
    if (shift_pressed) {
      canvas.style.cursor = "crosshair";
      var radius = sim_config.new_point_radius == -1 ? Math.random() * 10 : sim_config.new_point_radius;
      world.add_point(new Point(new Vector(drag_origin_x, drag_origin_y), 
                                ...
                                choose_point_color(), radius, sim_config.new_point_equilibrium_distance));
    }
